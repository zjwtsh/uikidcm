...
sm:add_state(bodyPause_getch);		--b51
sm:add_state(bodyPositionPB);

------------------------------------------------------
-- Advanced FSM (bodyPosition)
------------------------------------------------------

sm:set_transition(bodyStart, 'done', bodyPositionPB);

sm:set_transition(bodyPositionPB, 'timeout', bodyPositionPB);
sm:set_transition(bodyPositionPB, 'ballLost', bodySearch);
sm:set_transition(bodyPositionPB, 'ballClose', bodyOrbit);
sm:set_transition(bodyPositionPB, 'obstacle', bodyObstacle);
--sm:set_transition(bodyPosition, 'done', bodyApproach);
sm:set_transition(bodyPositionPB, 'done', bodyPause_getch);	--b51
sm:set_transition(bodyPositionPB, 'dribble', bodyDribble);
--sm:set_transition(bodyPositionPB, 'otherHalf', bodyStop);
...
sm:set_transition(bodySearch, 'ball', bodyApproach);--168
...
sm:set_transition(bodyGotoCenter, 'ballFound', bodyPositionPB);
...
sm:set_transition(bodyApproach, 'ballFar', bodyPositionPB);
sm:set_transition(bodyApproach, 'ballLost', bodySearch);
sm:set_transition(bodyApproach, 'timeout', bodyPositionPB);
sm:set_transition(bodyApproach, 'kick', bodyKick);
--sm:set_transition(bodyApproach, 'kick', bodyApproach);
...
sm:set_transition(bodyKick, 'done', bodyPositionPB);
sm:set_transition(bodyKick, 'timeout', bodyPositionPB);
sm:set_transition(bodyKick, 'reposition', bodyApproach);
sm:set_transition(bodyWalkKick, 'done', bodyPositionPB);

sm:set_transition(bodyReady, 'done', bodyReadyMove);
sm:set_transition(bodyReadyMove, 'fall', bodyReadyMove);

sm:set_transition(bodyPositionPB, 'fall', bodyPositionPB);
sm:set_transition(bodyDribble, 'fall', bodyPosition);
sm:set_transition(bodyApproach, 'fall', bodyPositionPB);
sm:set_transition(bodyKick, 'fall', bodyPositionPB);

sm:set_transition(bodyPause_getch, 'done', bodyPosition);	--b51
sm:set_transition(bodyPause_getch, 'go', bodyApproach);	--b51
