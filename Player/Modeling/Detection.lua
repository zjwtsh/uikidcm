...
function update()
	...
	headAngle = {Body.get_sensor_headpos()[2],Body.get_sensor_headpos()[1]};	--zjwtsh 

	-- All the detection is actually aquisition of ball availability, not running algorithm
	-- ball detector
  tstart = unix.time();
	--print("entering arbirary ball modeling routine");
	ball = modelBall.model(
