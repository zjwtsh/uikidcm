...
namespace BFL
{
  ...
  class NonlinearMeasurementPdf : public ConditionalPdf<preprocessedObservation, MatrixWrapper::ColumnVector>
    {
    public:
      /// Constructor
      /**
      ...
      */
      ...
      virtual Probability ProbabilityGet(const preprocessedObservation& measurement) const;
